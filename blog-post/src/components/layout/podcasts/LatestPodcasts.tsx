...
import Image1 from "../../../../public/images/post/img12.jpg"
import Image2 from "../../../../public/images/post/img13.jpg"
import Image3 from "../../../../public/images/post/img1.jpg"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Discover our newest releases featuring cutting-edge discussions on AI and technology
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                  <span className="inline-block px-3 py-1 bg-[#2a2a2a] text-yellow-400 rounded-full text-xs font-medium">
                    {episode.category}
                  </span>
                  <span className="text-sm text-gray-400">{episode.listens} listens</span>
                </div>
                
                <h3 className="text-xl font-bold text-white mb-3 line-clamp-2">{episode.title}</h3>
                <p className="text-gray-400 mb-6 line-clamp-3">{episode.description}</p>
        ...
        <div className="text-center mt-12">
          <button className="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-[#0f0f0f] px-6 py-3 rounded-lg font-bold transition-colors">
            Browse All Episodes <FiArrowRight />
          </button>
        </div>
      </div>
    </section>
